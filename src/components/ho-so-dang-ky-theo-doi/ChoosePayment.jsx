...
const ChoosePayment = () => {
    ...
    const qrUrl = `https://qr.sepay.vn/img?bank=MBBank&acc=0834885704&template=compact&amount=${bookingServiceData.bookingServiceRecord.priceList.price}&des=MaKH${userData.user?._id}`
    const handleSubmit = () => {
