...
const NotificationApp = () => {
        ...
        if (
            ...
            api({
                ...
                if (item.title.toLowerCase().trim() === 'lịch hẹn') {
                    api({ sendToken: false, path: `/appointments/get-one/${item.attached}`, type: TypeHTTP.GET })
                        .then(res1 => {
    ...
    return (
        <div className="relative mr-3">
            ...
            <div
                className={`z-50 w-[300px] shadow-lg overflow-hidden absolute top-[30px] right-0 bg-white rounded-md transition-all duration-500 ${visibleUserInfo
                    ? "h-[315px] opacity-100"
                    : "h-0 opacity-0"
                    }`}
            >
