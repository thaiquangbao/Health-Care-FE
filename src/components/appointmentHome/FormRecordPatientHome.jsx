...
const FormRecordPatientHome = ({data, hidden}) => {
  ...
  const updateMedicalRecord = () => {
    api({
      ...
      body: {
        ...
        diagnosisDisease:
          appointmentData.medicalRecord.diagnosisDisease,
        ...
        <div className="px-[2rem] py-[1.5rem] w-full flex flex-col">
            ...
            <div className="flex items-center gap-4 ">
              ...
              <div className="flex flex-col">
                <span className="font-medium">
                  {
                    appointmentData.medicalRecord?.patient
                      ?.fullName
                  }
                </span>
          ...
          <div className="grid grid-cols-3 h-auto gap-x-[0.5rem] mt-[0.5rem]">
            ...
            <div>
              ...
              {appointmentData.medicalRecord?.healthRate ===
              0
                ? "Không"
                : appointmentData.medicalRecord
                    ?.healthRate + " bpm"}
            ...
            <div>
              ...
              {appointmentData.medicalRecord?.weight === 0
                ? "Không"
                : appointmentData.medicalRecord?.weight +
                  " kg"}
            </div>
            <div>
              <span className="font-semibold px-2 mt-[1rem]">
              ...
              {appointmentData.medicalRecord?.height === 0
                ? "Không"
                : appointmentData.medicalRecord?.height +
                  " kg"}
            </div>
            <div>
              <span className="font-semibold px-2 mt-[1rem]">
          ...
          <div className="w-full flex mt-3 px-2">
            <div className="w-[50%] flex items-center justify-between">
              <input
                ...
                onChange={(e) =>
                  setReAppointmentDay(e.target.value)
                }
              ...
              <input
                ...
                className="text-[14px] w-[30%] h-[40px] bg-[white] border-[1px] border-[#cfcfcf] focus:outline-0 rounded-lg px-4"
                onChange={(e) =>
                  setReAppointmentMonth(e.target.value)
                }
              ...
              <input
                ...
                className="text-[14px] w-[30%] h-[40px] bg-[white] border-[1px] border-[#cfcfcf] focus:outline-0 rounded-lg px-4"
                onChange={(e) =>
                  setReAppointmentYear(e.target.value)
                }
