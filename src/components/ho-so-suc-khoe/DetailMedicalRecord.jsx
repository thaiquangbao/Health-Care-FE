...
const DetailMedicalRecord = ({ medicalRecord }) => {
    ...
    return (
        ...
        >
            <button onClick={() => authHandler.hiddenDetailMedicalRecord()}><i className='bx bx-x absolute right-2 top-2 text-[30px] text-[#5e5e5e]'></i></button>
            <div className="px-[2rem]  w-full flex flex-col">
                ...
                <div className="grid grid-cols-3 h-auto gap-x-[0.5rem] mt-[0.5rem]">
                    <div>
                        ...
                        {medicalRecord?.bloodPressure === "" ? 'Không' : medicalRecord?.bloodPressure + ' mmHg'}
                    </div>
                    <div>
                        <span className="font-semibold px-2 mt-[1rem]">
                            Nhịp tim:
                        </span>
                        {medicalRecord?.healthRate === 0 ? 'Không' : medicalRecord?.healthRate + ' bpm'}
                    </div>
                    <div>
                        <span className="font-semibold px-2 mt-[1rem]">
                            Cân nặng:
