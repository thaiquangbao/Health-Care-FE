        ...
        <div className="w-full min-h-screen pb-4 flex flex-col pt-[60px] px-[5%]">
            ...
            <div className='flex flex-col gap-2 items-center mt-6 px-[6rem]'>
                <div className='my-2 flex flex-col items-center'>
                    <h2 className='text-[23px] font-semibold flex items-end gap-3'>Chào {userData.user?.fullName}</h2>
                    <span className='font-medium text-[16px]'>Theo dõi sức khỏe với các bác sĩ để nhận lời khuyên tốt nhất</span>
                </div>
