            ...
            <div className="w-full min-h-screen pt-[60px] pb-4 flex flex-col background-public">
                ...
                <div className="flex relative flex-col gap-2 text-[30px] font-bold text-[#171717] w-[100%] items-center">
                    ...
                    <div className='flex-col gap-3 text-[white] absolute w-[50%] flex items-start justify-center top-[50%] translate-y-[-50%] left-[5%]'>
                        <span className='text-[40px]'>
                            Bạn thấy không khỏe?
                            Hãy để HealthHaven chăm sóc cho bạn!
                        </span>
                        <span className='text-[18px] font-medium'>
                            Tìm hiểu thêm về các dịch vụ chăm sóc sức khỏe của chúng tôi, từ cảm mạo thông thường đến các bệnh mạn tính - các bác sĩ Jio thân thiện sẽ tận tình chăm sóc bạn và gia đình.
                        </span>
                        <button style={{ background: 'linear-gradient(to right, #11998e, #38ef7d)' }} className='text-[16px] rounded-3xl px-6 py-3'>Đặt Khám Ngay</button>
                    </div>
                ...
                <div className="flex z-0 relative text-[30px] font-bold text-[#171717] mt-[4rem] w-[100%] items-center">
                    ...
                    <div className='absolute w-[35%] z-[5] flex flex-col gap-1 top-[50%] translate-y-[-50%] left-12'>
                        ...
                        <span></span>
                        <p className='text-[17px] font-medium text-[#404040]'>Dù cho bệnh trái gió trở trời, hay nhiễm khuẩn thì các Bác sĩ giàu kinh nghiệm của Jio Health luôn sẵn lòng khám bệnh ngay tại phòng khám, giúp bạn phục hồi nhanh chóng.</p>
