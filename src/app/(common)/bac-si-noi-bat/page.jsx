        ...
        <div className="w-full pt-[60px] min-h-screen flex flex-col px-[5%] background-public">
            ...
            <div className='w-full mt-[3rem] flex flex-col'>
                <div className='w-full flex flex-col items-center gap-1'>
                    <h1 className='text-[#6262ff] text-[22px] font-medium'>Đặt khám trước qua HealthHaven - Bác sĩ nổi bật</h1>
                    <span>Để được tiếp đón ưu tiên viện hoặc được tư vấn với bác sĩ giỏi ngay tại nhà</span>
                    <div className='w-[60%] relative mt-[1rem]'>
                        <input placeholder='Tìm Bác Sĩ' className='text-[14px] h-[50px] w-[100%] focus:outline-0 border-[1px] pl-[3rem] pr-[1rem] border-[#dadada] rounded-3xl' />
                ...
                <div className='w-full mt-[2rem] grid grid-cols-4 gap-5 pb-[2rem]'>
                    {doctorRecords.map((item, index) => (
                        <div key={index} className='bg-[white] shadow-xl shadow-[#35a4ff2a] pt-[1rem] overflow-hidden rounded-lg justify-center items-center flex flex-col'>
                            ...
                            <button onClick={() => router.push(`/ho-so-bac-si/${item.doctor?._id}`)} className='mt-[1rem] py-3 flex items-center justify-center gap-1 text-[white] bg-[#5050ff] font-medium text-[15px] w-full'>
